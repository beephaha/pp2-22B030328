...
back = pygame.image.load('lab7/mickey/images/background.jpeg')
hand_right = pygame.image.load('lab7/mickey/images/minutes.png')
hand_left = pygame.image.load('lab7/mickey/images/seconds.png')
