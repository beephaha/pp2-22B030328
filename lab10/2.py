...
def gameLoop(text):
    ...
    query_create_user = "INSERT INTO users (user_name, user_score) VALUES (%s, %s) ;"
    query_update_user = "Update users set user_score=%s where user_name =%s ;"
    query_get_user ="select*from users where user_name='"+text+"';"
